...
def seed_database(force=False):
    ...
    demo_users = [
        ...
        # Diverse Seekers & Professionals across India
        {
            "name": "Vikramaditya Roy",
            "email": "vikram.roy@creator.in",
            "role": "seeker",
            "bio": "Indie podcaster, tech YouTuber, and audio producer. Recording weekly founder interviews and audio dramas.",
            "phone": "+91 98300 11223",
            "avatar_url": "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=200&q=80",
            "is_aadhaar_verified": True,
            "aadhaar_masked": "XXXX-XXXX-9104",
            "aadhaar_token_hash": "f6a7b8c9d0e1234567890abcdef1234567890abcdef1234567890abcdef12345",
            "objective_trust_score": 99.4,
            "on_time_vacate_rate": 100.0,
            "cleanliness_match_rate": 99.0,
            "total_completed_hours": 36.0,
            "dispute_count": 0
        },
        {
            "name": "Meera Nair",
            "email": "meera.nair@consultant.in",
            "role": "seeker",
            "bio": "Freelance strategic UX researcher and remote product designer. Needing quiet, distraction-free meeting rooms for client deep-dives.",
            ...
            "is_aadhaar_verified": True,
            "aadhaar_masked": "XXXX-XXXX-5821",
            "aadhaar_token_hash": "a7b8c9d0e1f234567890abcdef1234567890abcdef1234567890abcdef123456",
            "objective_trust_score": 98.9,
            "on_time_vacate_rate": 99.0,
            "cleanliness_match_rate": 98.5,
            "total_completed_hours": 28.0,
            "dispute_count": 0
        },
        {
            "name": "Arjun Singhal",
            "email": "arjun@nexusdev.in",
            "role": "seeker",
            "bio": "Co-founder of NexusDev AI. Regularly hosting team design sprints, architecture workshops, and investor pitch sessions.",
            "phone": "+91 98110 77889",
            "avatar_url": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=200&q=80",
            "is_aadhaar_verified": True,
            "aadhaar_masked": "XXXX-XXXX-3312",
            "aadhaar_token_hash": "b8c9d0e1f2a34567890abcdef1234567890abcdef1234567890abcdef1234567",
            "objective_trust_score": 99.1,
            "on_time_vacate_rate": 100.0,
            "cleanliness_match_rate": 99.2,
            "total_completed_hours": 44.0,
            "dispute_count": 0
        },
        {
            "name": "Rhea Chawla",
            "email": "rhea@chawlabakes.in",
            "role": "seeker",
            "bio": "Small business owner and artisan baker. Booking weekend pop-up retail stalls and tasting consultation spaces.",
            "phone": "+91 98200 33445",
            "avatar_url": "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=200&q=80",
            "is_aadhaar_verified": True,
            "aadhaar_masked": "XXXX-XXXX-4490",
            "aadhaar_token_hash": "c9d0e1f2a3b4567890abcdef1234567890abcdef1234567890abcdef12345678",
            "objective_trust_score": 97.8,
            "on_time_vacate_rate": 98.0,
            "cleanliness_match_rate": 98.0,
            "total_completed_hours": 20.0,
            "dispute_count": 0
        },
    ...
    spaces_data = [
        ...
        {
            "owner_id": host_vikram.id,
            "title": "Executive Glass Meeting & Client Consultation Suite",
            "category": "Meeting",
            "description": "Sound-insulated, frosted-glass 8-person conference suite with 65-inch 4K HDMI presentation display, Logitech Rally video conferencing bar, and high-speed enterprise fiber. Perfect for client presentations, executive interviews, and startup board meetings.",
            "address": "100 Feet Road, HAL 2nd Stage, Indiranagar",
            "neighborhood": "Indiranagar",
            "city": "Bengaluru",
            "state": "Karnataka",
            ...
            "geofence_radius_meters": 30,
            "physical_access_type": "caretaker_handshake",
            "discom_ca_number": "1902834190",
            "discom_consumer_name": "Vikram Mehra",
            "room_qr_token": "SPACELOOP_QR_BLR_INDIRA_MEET",
            "sqft": 320,
            "max_capacity": 8,
            "price_hourly": 120.0,
            "price_daily": 700.0,
            "minimum_hours": 1,
            "amenities": ["65-inch 4K Presentation TV", "Logitech 4K Conference Cam", "Gigabit Wi-Fi", "Dual Glass Whiteboards", "Air Conditioning", "Nespresso Coffee Bar"],
            "rules": ["Dispose of takeaway cups in pantry bin", "Mute video bar when not speaking", "Keep door closed during conference calls"],
            "photos": [
                "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1200&q=80",
                "https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&w=800&q=80"
            ],
            "ai_tags": ["Meeting Room", "Executive Suite", "Video Conferencing", "Indiranagar", "Client Ready"],
            "ai_dimensions_summary": "16ft x 20ft (320 sqft) boardroom with acoustic glass",
            "ai_lighting": "Dimmable 3500K presentation downlights + natural diffuse daylight",
            "ai_noise_level": "Whisper Quiet (<28 dB acoustic glass)",
            "ai_power_access": "Under-table pop-up HDMI/USB-C power hub with universal plugs",
            "ai_safety_notes": "First aid kit in pantry, emergency exit via building stairwell A.",
            "ai_recommended_uses": "Client presentations, investor pitches, executive interviews, board meetings",
            "ai_suitability_score": 98
        },
        {
            "owner_id": host_rajesh.id,
            "title": "Maker Workshop & Hardware Prototyping Bay",
            "category": "Workshop",
            "description": "Heavy-duty industrial maker workbench equipped with Weller digital soldering stations, 60Mhz dual-channel oscilloscope, bench power supply (0-30V 5A), ESD-safe matting, and extraction fan. Designed for IoT engineers, drone builders, and hardware creators.",
            ...
            "geofence_radius_meters": 35,
            "physical_access_type": "caretaker_handshake",
            "discom_ca_number": "3910294821",
            "discom_consumer_name": "Rajesh Kulkarni",
            "room_qr_token": "SPACELOOP_QR_BLR_MAKER_BAY",
            "sqft": 280,
            "max_capacity": 6,
            "price_hourly": 85.0,
            "price_daily": 500.0,
            "minimum_hours": 2,
            "amenities": ["Weller Soldering Station", "Rigol Digital Oscilloscope", "DC Regulated Power Supply", "ESD Grounded Bench", "Fume Extractor", "Safety Goggles & Tool Kit"],
            "rules": ["Wear safety goggles during soldering/drilling", "Always turn off soldering irons before leaving", "Dispose of lead wire clippings in designated hazard bin"],
            "photos": [
                "https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=1200&q=80",
                "https://images.unsplash.com/photo-1581092335397-9583fe92d232?auto=format&fit=crop&w=800&q=80"
            ],
            "ai_tags": ["Maker Space", "Hardware Lab", "Soldering Station", "Electronics", "IoT Prototyping"],
            "ai_dimensions_summary": "14ft x 20ft (280 sqft) grounded workbench lab",
            "ai_lighting": "High-CRI 5000K overhead task lighting + articulating desk magnifiers",
            "ai_noise_level": "Workshop Ambient (<55 dB)",
            "ai_power_access": "16A industrial sockets with isolation transformer and emergency kill switch",
            "ai_safety_notes": "CO2 fire extinguisher on bench side, eye-wash station at sink.",
            "ai_recommended_uses": "Hardware debugging, drone prototyping, IoT assembly, 3D print finishing",
            "ai_suitability_score": 96
        },
        {
            "owner_id": host_rajesh.id,
            "title": "Boutique High-Street Pop-Up Retail Space",
            "category": "Retail",
            "description": "Street-facing ground floor commercial pop-up space on bustling FC Road. Features warm track spotlights, modular wooden display shelving, clothing racks, fitting alcove, and high pedestrian footfall. Ideal for D2C brands, artisan pop-ups, and weekend sample sales.",
            ...
            "geofence_radius_meters": 30,
            "physical_access_type": "caretaker_handshake",
            "discom_ca_number": "4910283719",
            "discom_consumer_name": "Rajesh Kulkarni",
            "room_qr_token": "SPACELOOP_QR_PUN_POPUP_FC",
            "sqft": 350,
            "max_capacity": 15,
            "price_hourly": 140.0,
            "price_daily": 900.0,
            "minimum_hours": 3,
            "amenities": ["High Pedestrian Footfall", "Modular Display Shelving", "Track Spotlight Grid", "Fitting Curtain Alcove", "POS Cash Drawer & Wi-Fi", "Glass Front Showcase"],
            "rules": ["Keep sound levels compliant with local retail bylaws", "Sweep and clear floor packaging before checkout", "Ensure roll-down shutter is secured upon completion"],
            "photos": [
                "https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?auto=format&fit=crop&w=1200&q=80",
                "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=800&q=80"
            ],
            "ai_tags": ["Pop-up Retail", "FC Road", "Footfall", "Fashion & D2C", "Street Facing"],
            "ai_dimensions_summary": "15ft x 23ft (350 sqft) street-level retail showroom",
            "ai_lighting": "Overhead 3000K warm retail track spots with adjustable beam angles",
            "ai_noise_level": "Active Retail Commercial Ambient",
            "ai_power_access": "Multiple retail floor boxes for POS registers, lamps, and card terminals",
            "ai_safety_notes": "Main breaker box labeled behind cash counter, smoke detector installed.",
            "ai_recommended_uses": "D2C apparel pop-up, artisanal bakery showcase, design sample sale, pottery pop-up",
            "ai_suitability_score": 97
        },
        {
            "owner_id": host_sunita.id,
            "title": "Acoustic Music Rehearsal & Band Jam Room",
            "category": "Studio",
            "description": "Double-walled soundproofed basement rehearsal studio equipped with Yamaha 5-piece acoustic drum kit, Fender Champion 100 guitar amp, Hartke bass rig, PA system with 2 Shure SM58 microphones, and climate control. Designed for music bands, solo vocalists, and instrumental rehearsal.",
            "address": "A-2/15 Safdarjung Enclave",
            ...
            "geofence_radius_meters": 30,
            "physical_access_type": "caretaker_handshake",
            "discom_ca_number": "1004928189",
            "discom_consumer_name": "Sunita Sharma",
            "room_qr_token": "SPACELOOP_QR_DEL_SAF_MUSIC",
            "sqft": 300,
            "max_capacity": 6,
            "price_hourly": 110.0,
            "price_daily": 650.0,
            "minimum_hours": 2,
            "amenities": ["Yamaha Drum Kit", "Fender Guitar Amp", "Hartke Bass Amp", "PA System & 2x Shure Mics", "Soundproof Acoustic Walls", "Air Conditioning"],
            "rules": ["No food or unsealed liquids near electronic amplifiers", "Return mic cables coiled properly", "Keep sound level within calibrated 95 dB limit"],
            "photos": [
                "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?auto=format&fit=crop&w=1200&q=80",
                "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=800&q=80"
            ],
            "ai_tags": ["Music Studio", "Band Rehearsal", "Soundproof", "Drums & Amps", "Safdarjung"],
            "ai_dimensions_summary": "15ft x 20ft (300 sqft) sound-isolated chamber",
            "ai_lighting": "Atmospheric warm mood lighting + adjustable LED spots",
            "ai_noise_level": "Fully Soundproofed Studio (zero external leakage)",
            "ai_power_access": "Conditioned audio-grade power circuits with isolated ground",
            "ai_safety_notes": "Acoustic fire-retardant wall foam, illuminated emergency exit door.",
            "ai_recommended_uses": "Band practice, vocal recording, acoustic guitar rehearsal, drum tracking",
            "ai_suitability_score": 98
        },
        {
            "owner_id": host_vikram.id,
            "title": "Collaborative Startup Team Sprint & Brainstorm Room",
            "category": "Workspace",
            "description": "Vibrant team war-room configured for agile sprints and hackathons. Features 12ft magnetic ideation whiteboard wall, 6 Herman Miller ergonomic chairs, 55-inch casting monitor, high-speed dual WAN fiber, and dedicated stand-up area.",
            "address": "80 Feet Road, 7th Block, Koramangala",
            "neighborhood": "Koramangala",
            "city": "Bengaluru",
            "state": "Karnataka",
            "zip_code": "560095",
            ...
            "geofence_radius_meters": 30,
            "physical_access_type": "caretaker_handshake",
            "discom_ca_number": "1902834199",
            "discom_consumer_name": "Vikram Mehra",
            "room_qr_token": "SPACELOOP_QR_BLR_KOR_SPRINT",
            "sqft": 360,
            "max_capacity": 10,
            "price_hourly": 115.0,
            "price_daily": 680.0,
            "minimum_hours": 2,
            "amenities": ["12ft Magnetic Whiteboard Wall", "55-inch 4K Casting TV", "Ergonomic Mesh Chairs", "Dual WAN Fiber Internet", "Breakout Sofa Lounge", "Filtered Water & Coffee"],
            "rules": ["Erase whiteboards after sprint session", "Switch off TV display and AC upon leaving", "Keep shared building common areas quiet"],
            "photos": [
                "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=80",
                "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=800&q=80"
            ],
            "ai_tags": ["Team Sprint", "Startup War Room", "Whiteboard Wall", "Koramangala", "Hackathon"],
            "ai_dimensions_summary": "18ft x 20ft (360 sqft) collaborative war room",
            "ai_lighting": "High-illumination 4500K productivity lighting + large balcony windows",
            "ai_noise_level": "Moderate Team Collaboration Space",
            "ai_power_access": "Multiple table-top power towers with 12x laptop charging plugs",
            "ai_safety_notes": "Unobstructed double door exit, fire alarm sensor installed.",
            "ai_recommended_uses": "Team sprints, hackathon prep, product roadmapping, user interview analysis",
            "ai_suitability_score": 97
        },
        {
            "owner_id": host_rajesh.id,
            "title": "Ergonomic Remote Work & Focus Office (1Gbps Fiber)",
            "category": "Workspace",
            "description": "Private dedicated executive focus office designed for remote engineers and consultants. Equipped with motorized sit-stand desk, Herman Miller Aeron chair, Dell 32-inch 4K USB-C monitor, dedicated 1 Gbps fiber with zero-drop UPS, and sound-absorbing acoustic felt wall panelling.",
            ...
            "physical_access_type": "mechanical_keybox",
            "keybox_code": "7712",
            "discom_ca_number": "4910283722",
            "discom_consumer_name": "Rajesh Kulkarni",
            "room_qr_token": "SPACELOOP_QR_PUN_VIM_EXEC",
            "sqft": 180,
            "max_capacity": 2,
            "price_hourly": 65.0,
            "price_daily": 380.0,
            "minimum_hours": 1,
            "amenities": ["Motorized Sit-Stand Desk", "Herman Miller Aeron Chair", "Dell 32-inch 4K Monitor", "1 Gbps Dedicated Fiber", "6-Hour Inverter Backup", "Acoustic Felt Panelling"],
            "rules": ["Indoor slippers provided at entrance", "Please use coasters on sit-stand desk surface", "Switch off desk monitor before checkout"],
            "photos": [
                "https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=1200&q=80",
                "https://images.unsplash.com/photo-1505373877841-8d25f7d46678?auto=format&fit=crop&w=800&q=80"
            ],
            "ai_tags": ["Remote Work", "Sit-Stand Desk", "4K Monitor", "1 Gbps Internet", "Focus Office"],
            "ai_dimensions_summary": "12ft x 15ft (180 sqft) executive focus office",
            "ai_lighting": "Soft indirect LED perimeter cove lighting + BenQ screenbar lamp",
            "ai_noise_level": "Ultra Quiet Focus (<26 dB)",
            "ai_power_access": "Surge-protected 100W USB-C Power Delivery + 4x 3-pin sockets with UPS",
            "ai_safety_notes": "First aid kit in drawer, fire exit via main corridor.",
            "ai_recommended_uses": "Remote software development, remote consulting, client video calls, deep work",
            "ai_suitability_score": 99
        }
    ]
