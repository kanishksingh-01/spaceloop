...
def create_app():
    ...
    def precheck_booking():
        ...
        if hours is None and data.get("start_time") and data.get("end_time"):
            try:
                ...
                hours = validate_numeric(diff_hours, min_val=0.5, max_val=168.0, default=2.0)
            except Exception:
                hours = 2.0
        elif hours is None:
            hours = 2.0
    ...
    def ai_chat():
        ...
        # Support both messages array and message + history format
    ...
    # Serve Vite Standardized React Native Frontend
